...
export const ContextMenuDemos = () => {
  ...
  return (
    <DemoPage
      ...
      title="Context Menu"
      description="Practical file, editor, and project context menus for exercising nested submenus, grouped sections, toggles, shortcuts, mixed content, and destructive actions."
    >
      <DemoSection
        title="File Explorer"
