...
export const contextMenuItemVariants = cva(
  'group/context-menu-item relative grid cursor-default select-none grid-cols-[auto_1fr_auto] items-center gap-1.5 rounded-md px-1.5 py-1 text-sm outline-none data-disabled:(pointer-events-none opacity-50) data-highlighted:(bg-accent text-accent-foreground)',
  {
    defaultVariants: {
      color: 'default',
      size: 'md',
...
export type ContextMenuItemVariantProps = VariantProps<typeof contextMenuItemVariants>
